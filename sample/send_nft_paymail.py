...
def main(params):
    logger.info('OrdinalX NFT API Sample: Send NFT by Paymail')
    ...
    endpoint = '/api/v1/nft/paymail/send'
    ...
    if response.status_code == 201:
        logger.info(f'NFT(origin: {params.origin}) has been sent to {params.destination} successfully!')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--destination', required=True, help='Destination paymail address')
    parser.add_argument('-o', '--origin', required=True,  help='NFT origin to send')
